...
all_df = pd.read_csv("https://raw.githubusercontent.com/lizaathalya/Submission-Dicoding/dashboard/df.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('https://raw.githubusercontent.com/lizaathalya/Submission-Dicoding/dashboard/df.csv')
...
st.caption('Copyright (C) Liza Athalya 2024')